...
* **testlab:** add api docs during build ([5b5018d](https://github.com/strongloop/loopback-next/commit/5b5018d0ad00feb19c6082759286a6d548f145e3))
* **testlab:** decache files in TestSandbox when resetting it ([7878ae6](https://github.com/strongloop/loopback-next/commit/7878ae676403cbf1c08e631a400e2203b8be6c61))
* **testlab:** make sure `fixtures` is included in npm package ([6edfa9d](https://github.com/strongloop/loopback-next/commit/6edfa9de34e5d902692b0c9475a09913c0d674ac))
...
* fill out missing brackets in testlab readme ([5383f54](https://github.com/strongloop/loopback-next/commit/5383f54b35e6d32cd2748d7feba35a0332145743))
* fix lint error from prettier 1.12.1 ([63c2f37](https://github.com/strongloop/loopback-next/commit/63c2f372ad5071a10828db0535dee38a23377694))
...
* **testlab:** fix throw() and rejectedWith() types ([8ad9f66](https://github.com/strongloop/loopback-next/commit/8ad9f665fdfed047938b31d4c1db7a05c11cc3c9))
...
* remove extra index from export ([#1029](https://github.com/strongloop/loopback-next/issues/1029)) ([e1303a9](https://github.com/strongloop/loopback-next/commit/e1303a9d820c38675b1d47f4d2e8dbf6769795d7))
...
* **testlab:** switch to fs-extra instead of using fs ([#905](https://github.com/strongloop/loopback-next/issues/905)) ([06cdaaf](https://github.com/strongloop/loopback-next/commit/06cdaaf44f721672d1a4c368ae26fb8c515fa247))
...
* **testlab:** add `skipIf` helper ([48f3703](https://github.com/strongloop/loopback-next/commit/48f370361f2d7cbb415255f280e3a5b1b7741165))
* **testlab:** add a new helper deserializedFromJson ([8d105e4](https://github.com/strongloop/loopback-next/commit/8d105e4aaa4fc128004b73d5989dd897e0e499b4))
...
* implement TestSandbox.writeTextFile ([59ca3a0](https://github.com/strongloop/loopback-next/commit/59ca3a058015b089f145c3a867aab6e193811e15))
* **testlab:** add TestLab.writeJsonFile ([baa993b](https://github.com/strongloop/loopback-next/commit/baa993baf41327380b1a73e5db16b4fc5e2bb611))
* **testlab:** always use IPv4 host in HTTP server config ([3d487b2](https://github.com/strongloop/loopback-next/commit/3d487b20adb0e352b11c0739b025627e843a9a14))
...
* **testlab:** expose "sandbox.path" property ([1445ebd](https://github.com/strongloop/loopback-next/commit/1445ebd95befd45a555acc88a679653b3f1f7679))
* **testlab:** improve typings for `toJSON()` helper ([a64e860](https://github.com/strongloop/loopback-next/commit/a64e860833ffac530ea8810b966baa95bc215643))
...
* **testlab:** rework itSkippedOnTravis to support Jest framework ([c7e14ca](https://github.com/strongloop/loopback-next/commit/c7e14caca50e2827a0ee3ebfcdc96b9e5a0ccd74))

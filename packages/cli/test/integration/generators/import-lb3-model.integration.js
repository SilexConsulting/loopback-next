...
const generator = path.join(__dirname, '../../../generators/import-lb3-model');
...
// see tests/unit/import-lb3-model/migrate-model.test.ts

const {
  loadLb3App,
} = require('../../../generators/import-lb3-model/lb3app-loader');

const COFFEE_SHOP_EXAMPLE = require.resolve(
  '../../../../../examples/lb3-application/lb3app/server/server',
);

describe('lb4 import-lb3-model', function() {
